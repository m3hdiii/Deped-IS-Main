...
public class OrderDetailsController extends AbstractMainController<ArrayList<OrderDetails>, Long> {
    ...
    public ModelAndView renderCreatePage(@ModelAttribute("order-details") ArrayList<OrderDetails> entity) {
    ...
    public ModelAndView createActionWithRedirect(@Valid @ModelAttribute("order-details") ArrayList<OrderDetails> entity, final RedirectAttributes redirectAttributes) {
        return null;
    }
