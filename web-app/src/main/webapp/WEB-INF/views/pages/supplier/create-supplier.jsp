                    ...
                    <form:form commandName="supplier" method="post" class="form-horizontal"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-10 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input path="supplierContactNo1" type="text" class="form-control"
                                                    id="newSuppPhone" placeholder="ex. 09123456789"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="newSuppTelephone">Contact Number 2</label>
                                        <form:input path="supplierContactNo2" type="text" class="form-control"
                            ...
                            <div class="modal-footer">
                                <a href="/supplier/list" class="btn btn-default pull-left"><i
