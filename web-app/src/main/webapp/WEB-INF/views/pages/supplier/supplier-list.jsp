    ...
    <c:import url="../../includes/top-nav.jsp"/>
        ...
        <div class="warper container-fluid">
            ...
            <div class="btn-group visible-lg-inline-block">
                <a href="/supplier/create" class="btn btn-default tooltip-btn" data-toggle="tooltip" data-placement="top" title="Add Supplier"><i class="fa fa-plus"></i></a>
                            ...
                            <tr>
                                ...
                                <c:choose>
                                    <c:when test="${not empty supplier.picName}">
                                        <td>
                                            <img src="${baseUrl}${supplier.picName}" class="img-circle" alt="user image" width="50px" height="50px"/>
                                        </td>
                                    </c:when>
                                    <c:otherwise>
                                        <td>
                                ...
                                <td>
                                    <div class="btn-group visible-lg-inline-block">
                                        <a href="/supplier/update/${supplier.supplierId}" class="btn btn-purple tooltip-btn" data-toggle="tooltip" data-placement="top" title="Edit Supplier"><i
