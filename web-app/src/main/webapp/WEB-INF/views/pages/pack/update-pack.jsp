...
<c:import url="../../includes/head.jsp">
    <c:param name="title" value="Update Pack"/>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <form:form commandName="pack" method="post" class="form-horizontal" role="form">
                                ...
                                <h3 class="text-center">Update Pack</h3>
                                <div class="panel-body">
                                    <div class="col-md-10 col-sm-offset-1">
                                        ...
                                        <div class="form-group">
                                            <label for="updatePackName">Name</label>
                                            <form:input path="name" class="form-control" placeholder="Pack Name" id="updatePackName"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="updatePackDesc">Description</label>
                                            <form:textarea type="text" path="description" class="form-control"
                                                           placeholder="Pack Description Here..." cols="3" rows="3" id="updatePackDesc" maxlength="100"></form:textarea>
                                        </div>
