                                ...
                                <div class="panel-body padd-sm">
                                    ...
                                    <div class="col-md-12 no-padd">
                                        ...
                                        <div class="form-group col-md-5 no-padd">
                                            <form:input id="requestDateFromId" onclick="clickOnDateInput('requestDateFromId')" name="date" type="text" class="form-control form-control-flat input-sm" path="requestDateFrom" placeholder="MM/DD/YYY"/>
                                        </div>
                                        <div class="col-md-2 no-padd text-center margn-t-xs">
                                            To
                                        </div>
                                        <div class="form-group col-md-5 no-padd">
                                            <form:input id="requestDateToId" name="date" onclick="clickOnDateInput('requestDateToId')" type="text" class="form-control form-control-flat input-sm" path="requestDateTo" placeholder="MM/DD/YYY"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 no-padd margn-t-sm">
                                            ...
                                            <form:select class="form-control form-control-flat input-sm chosen-select" multiple="true" path="requestedUsers" id="reqUserList" items="${userList}" itemLabel="username"
                                    ...
                                    <div class="col-md-12 no-padd margn-t-sm">
                                        ...
                                        <div class="form-group col-md-5 no-padd">
                                            <form:input path="requestQuantityFrom" type="number" min="0" class="form-control form-control-flat input-sm" placeholder="0"/>
                                        </div>
                                        <div class="col-md-2 no-padd text-center margn-t-xs">
                                            To
                                        </div>
                                        <div class="form-group col-md-5 no-padd">
                                            <form:input path="requestQuantityTo" type="number" min="0" class="form-control form-control-flat input-sm" placeholder="0"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 no-padd">
                                        ...
                                        <form:select path="requestStatuses" items="${statuses}" itemLabel="name" class="form-control form-control-flat input-sm chosen-select" multiple="true" id="requestStat"/>
                                    </div>
                                    <div class="form-group col-md-12 no-padd">
                                        <label for="reqDetStat">Request Details Status</label>
                                        <form:select path="requestDetailsStatuses" class="form-control form-control-flat input-sm chosen-select" id="reqDetStat" multiple="true"
                                    ...
                                    <div class="col-md-12 padd-sm">
                                        ...
                                        <button name="xml" value="XML" class="btn btn-sm btn-success" data-toggle="tooltip"
                                                title="Send the Request">Import Excel</button>
                                    </div>
                                </div>
                            </form:form>
                        </div>
