            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default clearfix">
                    <div class="panel-body text-center no-padd padd-t-md">
                        ...
                        <h4>My Profile</h4>
                        <div class="no-padd">
                            <a href="/user/${user.username}" class="btn btn-primary btn-flat col-md-12 btn-sm"><span
                                    class="pull-left">View Profile</span><i
                                    class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default clearfix">
                    <div class="panel-body text-center no-padd padd-t-md">
                        ...
                        <h4>Request</h4>
                        <div class="no-padd">
                            <a href="/request/create" class="btn btn-success btn-flat col-md-12 btn-sm"><span
                                    class="pull-left">Create</span><i
                                    class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default clearfix">
                    <div class="panel-body text-center no-padd padd-t-md">
                        ...
                        <h4>My Requests</h4>
                        <div class="no-padd">
                            <a href="/request/summary" class="btn btn-danger btn-flat col-md-12 btn-sm"><span
                                    class="pull-left">Show List</span><i
                                    class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <h4>Manage Order</h4>
                            <div class="no-padd">
                                <a href="/order/approval-list" class="btn btn-info btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Approve</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <div class="no-padd">
                                <a href="/request/approval-list" class="btn btn-purple btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Approve</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <div class="no-padd">
                                <a href="/item-details/insert-data"
                                   class="btn btn-warning btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Insert Info</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <h4>Manage Order</h4>
                            <div class="no-padd">
                                <a href="/order/arrival-list" class="btn btn-purple btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Arrived Checklist</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <h4>Manage Request</h4>
                            <div class="no-padd">
                                <a href="/request/release-list" class="btn btn-primary btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Release</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="panel panel-default clearfix">
                        <div class="panel-body text-center no-padd padd-t-md">
                            ...
                            <h4>Order</h4>
                            <div class="no-padd">
                                <a href="/order/create" class="btn btn-success btn-flat col-md-12 btn-sm"><span
                                        class="pull-left">Create</span><i
                                        class="fa fa-arrow-circle-o-right pull-right padd-xs"></i></a>
                            </div>
