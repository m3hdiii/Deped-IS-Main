...
$("#side-by-side-bar").dxChart({
    dataSource: [
        { state: "First", year1998: 423.721, year2001: 476.851, year2004: 528.904 },
        { state: "Second", year1998: 178.719, year2001: 195.769, year2004: 227.271 },
        { state: "Third", year1998: 308.845, year2001: 335.793, year2004: 372.576 },
        { state: "Fourth", year1998: 348.555, year2001: 374.771, year2004: 418.258 },
        { state: "Out of Schedule", year1998: 160.274, year2001: 182.373, year2004: 211.727 }
    ],
...
$("#splineArea-chart").dxChart({
    ...
    series: [
        { valueField: "y2005", name: "Goods", color: '#FF404B', opacity: 0.8 },
        { valueField: "y2004", name: "Semi-Expendable", color: '#8D82B5', opacity: 0.8 }
    ],
    legend: {
        /*visible: true,
        horizontalAlignment: 'right',
